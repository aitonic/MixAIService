...
from src.app.components.connectors.pandas import PandasConnector, PandasConnectorConfig
from src.app.components.connectors.sql import SQLConnector, SQLConnectorConfig, PostgreSQLConnector #, SqliteConnector, SqliteConnectorConfig, MySQLConnector, MySQLConnectorConfig, PostgreSQLConnector, PostgreSQLConnectorConfig, OracleConnector, OracleConnectorConfig
# from app.components.connectors.airtable import AirtableConnector, AirtableConnectorConfig
# from app.components.connectors.yahoo_finance import YahooFinanceConnector, YahooFinanceConnectorConfig
...
class ConnectorFactory:
    ...
    def create_connector(self, connector_type: str, config: Union[dict, PandasConnectorConfig, SQLConnectorConfig], **kwargs) -> BaseConnector:
