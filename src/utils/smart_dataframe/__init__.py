...
from src.utils.helpers.df_validator import DfValidator
from pydantic import BaseModel

from src.app.components.connectors.base import BaseConnector
from src.utils.helpers.df_info import DataFrameType
...
class SmartDataframe:
    ...
    def __init__(
        self,
        df: Union[DataFrameType, BaseConnector], # type: ignore
        name: str = None,
...
def load_smartdataframes(
    dfs: List[Union[DataFrameType, Any]], config: Config # type: ignore
) -> List[SmartDataframe]:
    """
